      ...
      <div className="flex bg-[#C6AE82] rounded items-stretch">
        <form onSubmit={handleSubmit} className="p-4 space-y-2 sm:w-1/2 h-full">
          ...
          <input
            ...
            className="border rounded-md p-2 focus:outline-none ring-1 ring-[#C6AE82] shadow-xl placeholder:text-sm"
            type="email"
            name="email"
          ...
          <div className="mt-5 flex items-center ml-3">
            <p className="text-sm mr-3">Dont have an account?</p>
            <Link to={"/signup"}>
              <span className="text-amber-950 hover:underline">Signup</span>
            </Link>
          </div>
        </form>
